...
const expectedPages = [
  ...
  { slug: 'partners', label: 'Partners', route: '/partners' },
  { slug: 'become-partner', label: 'Become a Partner', route: '/partners/become-partner' },
  { slug: 'news', label: 'News', route: '/news' },
  { slug: 'resources', label: 'Resources', route: '/resources' },
  { slug: 'resources-articles', label: 'Articles', route: '/resources/articles' },
  { slug: 'resources-faq', label: 'FAQ', route: '/resources/faq' },
  { slug: 'resources-videos', label: 'Videos', route: '/resources/videos' },
  { slug: 'case-studies', label: 'Case Studies', route: '/resources/case-studies' },
  { slug: 'challenges', label: 'Challenges', route: '/challenges' },
