...
const navItems: NavEntry[] = [
  ...
  { label: 'Users', href: '/admin/users', icon: 'shield-user', superadminOnly: true },
  { label: 'Audit log', href: '/admin/audit-log', icon: 'scroll', superadminOnly: true },
...
function NavIcon({ icon }: { icon: string }) {
  switch (icon) {
    ...
    case 'shield-user':
      return (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016A11.955 11.955 0 0112 2.944z" />
          <circle cx="12" cy="10" r="2" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} />
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-64 bg-secondary-900 text-white flex flex-col z-50">
      <div className="p-6 border-b border-secondary-700">
        <Link href="/admin" className="text-xl font-bold font-poppins tracking-wide">
          COIN Admin
        </Link>
      </div>
      ...
      <div className="p-4 border-t border-secondary-700">
        <a
          ...
          className="flex items-center gap-2 text-sm text-secondary-400 hover:text-white transition-colors"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
